...
class VideoPublicationDialog(QDialog):
    ...
    def _create_page_content(self):
        ...
        try:
            ...
            self.i_caption.setPlaceholderText("Texte affiché en overlay sur la vidéo")
            lay.addRow("Légende :", self.i_caption)
    ...
    def _create_page_engagement(self):
        """Page 5: Engagement — likes, comments, shares."""
        try:
    ...
    def _populate(self, pub_data):
        try:
            ...
            self.i_caption.setText(pub_data.get("caption", "") or pub_data.get("text", "") or "")
    ...
    def get_data(self):
        try:
            caption = self.i_caption.text().strip()
